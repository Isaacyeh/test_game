...
fetch("/sprites.json")
  ...
  .then((data) => {
    // Add default sprite
    compressedSprites.add(
      "https://www.clker.com/cliparts/a/4/1/d/1301963432622081819stick_figure%20(1).png"
    );
...
function drawLeaderboard(canvas, ctx) {
  ...
  ctx.fillText(
    "KILLS",
    startX + padX + colW[0] + colW[1] / 2,
    startY + headerH + 10
  );
  ctx.fillText(
    "DEATHS",
    startX + padX + colW[0] + colW[1] + colW[2] / 2,
    startY + headerH + 10
  );
